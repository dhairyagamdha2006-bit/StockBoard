      ...
      <div className="w-full max-w-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-black/[0.08] dark:border-white/[0.08] p-6">
            ...
            <p className="text-xs text-gray-500 font-sans mb-4">Works immediately — no developer app or approval needed.</p>
            <Link
              href="/connect/schwab/csv"
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-black/[0.08] dark:border-white/[0.08] p-6">
            ...
            {a.oauthConfigured ? (
              <>
                <p className="text-xs text-gray-500 font-sans mb-4">Official Schwab API, read-only, auto-refreshing.</p>
              ...
              <p className="text-xs text-gray-400 font-sans flex items-start gap-1.5">
                ...
                OAuth isn&apos;t configured on this deployment. It requires an approved Schwab developer app. Use CSV import above.
              </p>
            )}
          </div>
        </div>
